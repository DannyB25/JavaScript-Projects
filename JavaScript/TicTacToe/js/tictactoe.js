...
function placeXOrO(squareNumber) {
    ...
    function computersTurn() {
        //This boolean us needed for our while loop.
        let success = false;
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2){ x+= 10; }
            //This conditions adds 10 to the previous end y endpoint.
            if (y < y2) { y += 10; }
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        //This removes our elements brackgroundImage.
